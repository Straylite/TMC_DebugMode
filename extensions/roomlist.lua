...
function warptext()
	...
	if help == false and warpmenu == true then	
		...
		gui.drawBox(1-2+240,0+115+low, 400, 0+123+low, 0x00FFFFFF, 0xA0457599)
		gui.drawBox(1-2+240,0+122+low, 400, 0+130+low, 0x00FFFFFF, 0xA000589c)
		gui.pixelText(2+240,0+x+2+low, areatext, "white", 0x60000000)
		gui.pixelText(2+240,0+x+9+low, roomtext, "white", 0x60000066)
